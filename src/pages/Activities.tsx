      ...
      <div className="min-h-screen gradient-soft flex items-center justify-center p-4">
        <Card className="max-w-md w-full p-8 text-center shadow-romantic border-love-pink/20">
          ...
          <p className="text-muted-foreground mb-6">
            You need to connect with your partner before you can enjoy activities together.
          </p>
  ...
  return (
    <div className="min-h-screen gradient-soft">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-script text-xl text-primary">Activities</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <CoupleActivities coupleId={coupleId} />
      </div>
    </div>
  );
}